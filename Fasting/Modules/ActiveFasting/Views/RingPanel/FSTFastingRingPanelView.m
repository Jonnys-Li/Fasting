...
- (void)applyPresentationState {
    self.ring.progressColor = [UIColor fst_eatingTimeGreen];
    self.ring.endTailColor = [UIColor fst_progressCream];
    self.ring.endTailFraction = 0.10;
    self.ring.showsEndTail = self.presentationState == FSTRingPresentationOvertime;
    self.ring.completed = NO;
