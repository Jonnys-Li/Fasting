...
/// 读取方：FSTDailyPlanReadyView 内部 — 控制按钮标题（Start XX Fasting / Abort）、配色、tap 回调走 onStartFastingTapped 还是 onAbortPlanTapped。
...
@interface FSTDailyPlanReadyView : UIView
