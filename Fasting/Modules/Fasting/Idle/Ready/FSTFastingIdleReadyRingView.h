...
/// 读取方：FSTFastingIdleReadyRingView 内部 — 切换填充策略（Forward vs ReceedingFromStart）、配色、中心文本布局。
...
@interface FSTFastingIdleReadyRingView : UIView
